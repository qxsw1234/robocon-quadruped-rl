...
| 指标 | 值 |
|---|---|
| 总环境步数 | 147,456,000（1500 迭代 × 24 步 × 4096 环境） |
| 训练耗时 | ~42 分钟（RTX 4060 Laptop） |
| 吞吐 | ~61k steps/s |
| 速度跟踪误差（vx=1.0） | 见 results/ |
| 站立/行走演示视频 | results/videos/ |

训练曲线与奖励实验见 [results/](results/)、[dev_notes/](dev_notes/)。
